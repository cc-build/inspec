  ...
  module Compliance
    class API
      module Login
        ...
        def login(options)
          raise ArgumentError, "Please specify a server using `#{ChefUtils::Dist::Inspec::EXEC} compliance login https://SERVER`" unless options["server"]
          ...
          when :compliance
            ...
            raise CannotDetermineServerType, "Unable to determine if #{options["server"]} is a #{ChefUtils::Dist::Automate::PRODUCT} or #{ChefUtils::Dist::Compliance::PRODUCT} server"
          end
        end
        ...
        module ComplianceServer
          ...
          def self.compliance_verify_thor_options(o)
            ...
            error_msg.push("Please specify a server using `#{ChefUtils::Dist::Inspec::PRODUCT} compliance login https://SERVER`") if o["server"].nil?
